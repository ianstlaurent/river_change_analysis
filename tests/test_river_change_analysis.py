...
river_change_analysis.authenticate_gee()
region = river_change_analysis.define_roi([])
river_change_analysis.process_images(1986, 1989, region, 'CSC_497', 'Active_channel_binary_mask_python_')
